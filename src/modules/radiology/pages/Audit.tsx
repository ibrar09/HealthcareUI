...
import type { AuditEntry } from "@modules/radiology/api";
...
export function Audit() {
  ...
  return (
    <RadiologyLayout active="Audit">
      <div className="mb-5">
        <h1 className="text-xl font-bold text-slate-800">Audit Log</h1>
        <p className="text-xs text-slate-500 mt-0.5">Read-only view, including image access. The backend is the authoritative, tamper-evident audit source.</p>
      </div>
